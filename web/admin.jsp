        ...
        <div id="mws-wrapper">
            ...
            <div id="mws-sidebar">
                ...
                <div id="mws-navigation">
                    <ul>
                        <li class="active"><a href="admin.jsp" class="mws-i-24 i-home">Dashboard</a></li>
                        ...
                        <li><a href="#" class="mws-i-24 i-excel-documents-1">Question Bank</a>
                            <ul class="closed">
                                <li><a href="aques_add.jsp">Add Questions</a></li>
                            </ul>
                        </li>
